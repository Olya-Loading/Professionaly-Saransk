...
@Composable
fun ExcerciseAnimalsSuccessScreen(modifier: Modifier = Modifier) {
        Scaffold(
            ...
            Column(
                ...
                Text(
                    ...
                    fontSize = 20.sp,
                    fontFamily = FredokaFamily,
                    modifier = Modifier.padding(top = 45.dp, bottom = 45.dp)
                )
                Button(
                    onClick = {},
...
@Preview
@Composable
private fun AnimalSuccess() {
    SaranskTheme { ExcerciseAnimalsSuccessScreen(modifier = Modifier) }
}